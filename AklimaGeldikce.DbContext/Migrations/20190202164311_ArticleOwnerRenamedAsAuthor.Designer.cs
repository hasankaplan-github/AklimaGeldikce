...
namespace AklimaGeldikce.DbContext.Migrations
{
    ...
    [Migration("20190202164311_ArticleOwnerRenamedAsAuthor")]
    partial class ArticleOwnerRenamedAsAuthor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AklimaGeldikce.Entities.ArticleOperation", b =>
                {
                    ...
                    b.Property<Guid>("ArticleStatePathId");
            ...
            modelBuilder.Entity("AklimaGeldikce.Entities.ArticleStatePath", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("AklimaGeldikce.Entities.ArticleOperation", b =>
                {
                    ...
                    b.HasOne("AklimaGeldikce.Entities.ArticleStatePath", "ArticleStatePath")
                        .WithMany()
                        .HasForeignKey("ArticleStatePathId")
                        .OnDelete(DeleteBehavior.Cascade);
